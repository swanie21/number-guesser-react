...
class Application extends React.Component {
  ...
  saveUserMinRange(e) {
    ...
    this.setState({ userMin: userMinInput, min: userMinInput});
  }

  saveUserMaxRange(e) {
    const userMaxInput = e.target.value;
    this.setState({ userMax: userMaxInput, max: userMaxInput });
  }
  ...
  render() {
    return (
      <div className = "Application">
        ...
        <p>user min: {this.state.userMin}</p>
        <p>user max: {this.state.userMax}</p>
